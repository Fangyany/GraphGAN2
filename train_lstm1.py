...
def main():
    ...
    # ckpt_path_g = 'results_alpha/lanegcn/generator35.928.ckpt'
    # ckpt_path_d = 'results_alpha/lanegcn/discriminator35.928.ckpt'
    ...
    log = os.path.join(save_dir, "log4")
